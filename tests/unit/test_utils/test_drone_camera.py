...
from orbit.utils.camera_model import (
    DroneCameraModel,
    _build_projection_matrix,
    _rotation_matrix,
)
from orbit.utils.coordinate_transform import DroneAssistedTransformer
...
class TestDroneCameraModel:
    ...
    def test_focal_solved_from_gcps(self):
        ...
        f_true = 2000.0
        W, H = 4000, 3000
        from orbit.utils.camera_model import _build_projection_matrix
