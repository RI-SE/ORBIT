"""Tests for orbit_core.importers.osm_parser module."""


import pytest

# Import from orbit_core.importers using importlib (import is a reserved keyword)
from orbit_core.importers.osm_parser import OSMData, OSMNode, OSMParser, OSMRelation, OSMWay, parse_osm_data
