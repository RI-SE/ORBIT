"""Tests for orbit_core.importers.osm_importer module."""
...
from orbit_core.importers.osm_query import OverpassAPIError
...
class TestOSMImporterImportModes:
    ...
    def project_with_data(self):
        ...
        project = Project()
        from orbit_core.models import Polyline, Road
