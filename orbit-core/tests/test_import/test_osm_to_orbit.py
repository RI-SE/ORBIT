"""Tests for orbit_core.importers.osm_to_orbit module."""
...
from orbit_core.importers.osm_parser import OSMData, OSMNode, OSMRelation, OSMWay
from orbit_core.models import Junction, Road
...
class TestCreateObjectFromOsm:
    ...
    def test_creates_guardrail_from_way(self, mock_osm_way, mock_transformer):
        ...
        from orbit_core.importers import osm_parser
