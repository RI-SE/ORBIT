"""Tests for orbit_core.importers.roundabout_handler module."""
...
from orbit_core.importers.osm_parser import OSMData, OSMNode, OSMWay
from orbit_core.importers.roundabout_handler import (
    ConnectionPoint,
    RoundaboutInfo,
    _calculate_endpoint_heading,
    _calculate_ring_tangent,
    _create_ring_lane_section,
    _create_single_ring_road,
    _get_road_lane_width,
    _get_road_type_from_tags,
    _get_roundabout_name,
    _is_approach_incoming,
    _is_approach_outgoing,
    analyze_roundabout,
    create_ring_segments,
    create_roundabout_junctions,
    find_shared_nodes,
)
from orbit_core.models import Junction, Polyline, Road
from orbit_core.models.lane import Lane
from orbit_core.models.lane_section import LaneSection
from orbit_core.models.polyline import LineType
