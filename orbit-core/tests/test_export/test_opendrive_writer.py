"""Tests for orbit_core.export.opendrive_writer module."""
...
from orbit_core.models.junction import LaneConnection
from orbit_core.models.lane import Lane
from orbit_core.models.lane import LaneType as ModelLaneType
from orbit_core.models.road import RoadType
...
class TestValidateOpendrive:
    ...
    def test_validate_missing_xmlschema(self, tmp_path):
        ...
        writer_module = sys.modules['orbit_core.export.opendrive_writer']
        with patch.object(writer_module, 'validate_opendrive_file') as mock_validate:
