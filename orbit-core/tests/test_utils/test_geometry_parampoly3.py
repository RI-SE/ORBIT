...
class TestCalculateHermiteParampoly3:
    ...
    def test_straight_line(self):
        ...
        from orbit_core.utils.geometry import calculate_hermite_parampoly3
...
class TestSampleParampoly3:
    ...
    def test_sample_straight_line(self):
        ...
        from orbit_core.utils.geometry import sample_parampoly3
...
class TestEvaluateParampoly3Global:
    ...
    def test_transform_to_global(self):
        ...
        from orbit_core.utils.geometry import evaluate_parampoly3_global
...
class TestCalculateBezierControlPoints:
    ...
    def test_small_angle_scurve(self):
        ...
        from orbit_core.utils.geometry import calculate_bezier_control_points
...
class TestBezierToParampoly3:
    ...
    def test_quadratic_bezier(self):
        ...
        from orbit_core.utils.geometry import bezier_to_parampoly3
...
class TestSampleBezier:
    ...
    def test_sample_quadratic(self):
        ...
        from orbit_core.utils.geometry import sample_bezier
...
class TestCalculateArcParameters:
    ...
    def test_quarter_circle_ccw(self):
        ...
        from orbit_core.utils.geometry import calculate_arc_parameters
...
class TestCalculateTangentHeading:
    ...
    def test_tangent_at_east(self):
        ...
        from orbit_core.utils.geometry import calculate_tangent_heading
...
class TestSplitBoundaryAtCenterlineS:
    ...
    def test_split_parallel_boundary(self):
        ...
        from orbit_core.utils.geometry import split_boundary_at_centerline_s
...
class TestMergePolylinesAtJunction:
    ...
    def test_merge_connected(self):
        ...
        from orbit_core.utils.geometry import merge_polylines_at_junction
...
class TestFindGeoPointAtDistanceAlongPath:
    ...
    def test_find_point_at_start(self):
        ...
        from orbit_core.utils.geometry import find_geo_point_at_distance_along_path
...
class TestShortenGeoPoints:
    ...
    def test_shorten_from_start(self):
        ...
        from orbit_core.utils.geometry import shorten_geo_points
