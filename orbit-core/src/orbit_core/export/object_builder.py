...
from orbit_core.models import Road
from orbit_core.models.object import ObjectType, RoadObject
from orbit_core.utils.geo_sync import polyline_to_metric_points
...
class ObjectBuilder:
    ...
    def _sample_geometry(s: float, geometry_elements) -> tuple:
        ...
        """
        from orbit_core.export.reference_line_sampler import _sample_element
