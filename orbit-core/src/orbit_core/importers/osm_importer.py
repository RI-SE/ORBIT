...
from orbit_core.utils.geometry import clip_polygon_to_bbox, clip_polyline_to_bbox
...
class OSMImporter:
    ...
    def __init__(self, project: Project, transformer: CoordinateTransformer,
        ...
        # Set by import_osm_data / import_from_osm_data from the query bbox.
    ...
    def _ensure_clip_bbox(self, import_bbox: Optional[tuple] = None) -> None:
        ...
        """
        from orbit_core.utils.coordinate_transform import HybridTransformer
    ...
    def _get_osm_to_orbit_module(self):
        ...
        from orbit_core.importers import osm_to_orbit
    ...
    def import_osm_data(self, options: ImportOptions = None,
        ...
        return self.import_from_osm_data(osm_data, options, bbox=bbox)

    def import_from_osm_data(self, osm_data: OSMData, options: ImportOptions,
                             bbox: Optional[tuple] = None) -> ImportResult:
        """
