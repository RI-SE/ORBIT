...
from orbit_core.models import Junction, ParkingSpace, Road, RoadObject, Signal
...
from orbit_core.utils.geo_constants import METERS_PER_DEGREE
from orbit_core.utils.geometry import calculate_path_length, find_point_at_distance_along_path, shorten_geo_points
...
def _create_path_road(osm_way: OSMWay, centerline: Polyline,
    ...
    from orbit_core.models.road import LaneInfo
